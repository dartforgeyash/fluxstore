...
class NavigatorService {
  ...
  static Future<dynamic> push(BuildContext context, Widget routeChild, {dynamic argument}) async {
  ...
  static Future<dynamic> pushReplace(BuildContext context, Widget routeChild) async {
